...
namespace Trading.Proto {
  ...
  public static partial class TradingService
  {
    ...
    public abstract partial class TradingServiceBase
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::System.Threading.Tasks.Task GetTrades(grpc::IAsyncStreamReader<global::Trading.Proto.HealthRequest> requestStream, grpc::IServerStreamWriter<global::Trading.Proto.Trade> responseStream, grpc::ServerCallContext context)
      {
        throw new grpc::RpcException(new grpc::Status(grpc::StatusCode.Unimplemented, ""));
      }
    ...
    public static void BindService(grpc::ServiceBinderBase serviceBinder, TradingServiceBase serviceImpl)
    {
      ...
      serviceBinder.AddMethod(__Method_GetTrades, serviceImpl == null ? null : new grpc::DuplexStreamingServerMethod<global::Trading.Proto.HealthRequest, global::Trading.Proto.Trade>(serviceImpl.GetTrades));
